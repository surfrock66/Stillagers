...
execute as @e[type=minecraft:villager,name="Stillager"] run data merge entity @s {CustomName:"{\"text\":\"Stillager\"}",NoAI:1}
execute as @e[type=minecraft:villager,name="stillager"] run data merge entity @s {CustomName:"{\"text\":\"Stillager\"}",NoAI:1}
execute as @e[type=minecraft:villager,name="Moveager"] run data merge entity @s {CustomName:"{\"text\":\"Moveager\"}",NoAI:0}
execute as @e[type=minecraft:villager,name="moveager"] run data merge entity @s {CustomName:"{\"text\":\"Moveager\"}",NoAI:0}
